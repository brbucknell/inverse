    ...
    <main className="relative min-h-screen overflow-hidden bg-black font-serif">
      ...
      <section className="relative z-10 min-h-screen">
        <header className="pt-8 text-center">
          ...
          <nav className="mt-28 mx-auto flex w-fit flex-wrap justify-center gap-x-10 gap-y-3 rounded-xl border border-yellow-500/20 bg-black/50 px-8 py-3 text-xl font-bold backdrop-blur-sm">
            {realms.map((realm) => (
              <button
                key={realm.name}
